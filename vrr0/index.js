// INFO
// This implements a replica (that is intended to be run with other replicas)
// that receives client requests, stores the message in a log,
// sends the message to other replicas, waits for other replicas
// to ack, and then 
